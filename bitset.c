...
extern inline void bitset_setbit(bitset_index_t *name, unsigned index, bool set);
extern inline unsigned long bitset_getbit(bitset_index_t *name, unsigned index);
#endif
